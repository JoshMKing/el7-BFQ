...
%ifarch i686
# 32-bit kernel, headers, perf & tools.
...
%ifarch x86_64
# 64-bit kernel, headers, perf & tools.
%define with_doc 0
%endif
...
# Sources.
Source0: ftp://ftp.kernel.org/pub/linux/kernel/v3.x/linux-%{LKAver}.whl.tar.xz
...
%changelog
* Sun Feb 22 2015 Josh King <jking@webhostlabs.com> - 3.19.0-1.whl
- Initial release 3.19.0 + BFQ as default IO scheduler
